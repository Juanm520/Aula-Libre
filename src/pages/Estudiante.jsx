...
const courses = [
  { id: 1, name: 'Ciencias Naturales', excerpt: '< Lorem ipsum >' },
  { id: 2, name: 'Ciencias Sociales', excerpt: '< Lorem ipsum >' },
  { id: 3, name: 'Matemáticas', excerpt: '< Lorem ipsum >' },
]
      ...
      <div className="dashboard-container">
        ...
        <main className="dashboard-main">
          <section className="courses-section">
            <h2>Cursos Quinto de Primaria</h2>
